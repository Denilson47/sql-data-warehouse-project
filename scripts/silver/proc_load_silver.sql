...
--
-- Actions Performed:
--   - Truncates Silver tables to ensure idempotency (re-runnability).
--   - Inserts transformed and cleansed data from Bronze into Silver tables.
--   - Implements error handling and performance logging.
--
-- Parameters:
--   None.
...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO silver.crm_cust_info (
            ...
            cst_maritalstatus, cst_gndr, cst_create_date
        )
        SELECT 
            cst_id, cst_key,
        ...
        -- 4. Load ERP Customer Demographics
        SET @start_time = GETDATE();
